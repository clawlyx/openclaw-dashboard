...
6. Confirm working-agent provenance in `Agents`.
- URL:
  - `/?view=agents&panel=virtual`
- Expected:
...
7. Confirm the concise coordination layer.
- Expected:
...
8. Confirm API behavior for local archive mutations and retired remote mutation paths.
- Commands:
